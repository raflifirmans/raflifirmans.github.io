...
$query = "INSERT INTO tb_book (id_book,judul_meeting,pemohon,snack,makan_siang,jumlah_peserta,pic,notelp_pic,tanggal,jam_mulai,jam_selesai,catatan,id_ruang,id_user)  VALUES ('$idbook','$judulmeeting','$pemohon','$bagian','$snack','$makansiang','$jumlahpeserta','$pic','$notelppic','$tanggal','$mulai:00','$selesai:00','$catatan','$idruang','$iduser')";
...
//  $jumlahpeserta=$_POST['jumlahpeserta'];
  ...
  if ($_POST['tanggal'] !=null) { // tanggal fix
    ...
    if ($row>0) {
      ...
      // insert table book
      $query = "UPDATE tb_book where id_book='$idbook'(judul_meeting,pemohon,snack,makan_siang,jumlah_peserta,pic,notelp_pic,tanggal,jam_mulai,jam_selesai,id_ruang,id_user)  VALUES ('$judulmeeting','$divisi','$bagian','$snack','$makansiang','$jumlahpeserta','$pic','$notelppic','$tanggal','$mulai:00','$selesai:00','$catatan','$idruang','$iduser')";
