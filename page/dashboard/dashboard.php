    ...
    <div class="col-sm-4">
      ...
      <!-- box header -->
        ...
        <br>
          ...
          $sql ="SELECT *
                FROM tb_ruang
                WHERE id_ruang NOT IN (SELECT distinct id_ruang FROM tb_book where tanggal=CURDATE())";
         ...
         <div  class="table-responsive">
          <table class="table table-hover table-bordered table-striped text-center table-data" width="100%">
            ...
            <tbody>
              ...
              $sql ="SELECT bk.id_book,nama_ruang,judul_meeting,pemohon,tanggal,jam_mulai,jam_selesai,nama_user FROM tb_book bk
