    ...
    <section class="content">
      ...
      <!-- box header -->
        ...
        <div class="box-body">
          ...
          ?>
          <form class="form-horizontal" action="../../function/book-edit.php" method='post'>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control  edited" name="pemohon" required="true" 
                value="<?=$result['pemohon']?>">
              </div>
            ...
            <div class="form-group tanggal-hari">
              ...
              <div class="col-sm-10">
                ...
                value="<?= date("d M Y",strtotime($result['tanggal'])) ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type='text' class="form-control  edited" name="catatan" 
            ...
            <div class="col-sm-2 pull-right">
              ...
              <button type="button" class="btn btn-danger edited" data-toggle="modal" data-target="#modal-hapus"> Hapus </button>
              <button type="submit" class="btn btn-primary edited" name=edit>Simpan</button>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <a href="../../function/book-edit.php?hapus=true&idbook=<?=$result['id_book']?>&tanggal=<?=$result['tanggal']?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
