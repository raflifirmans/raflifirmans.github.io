        ...
        <div class="box-body">
          ...
          <form class="form-horizontal" action="../../function/user-model.php" method='post'>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label class="col-sm-offset-2 col-sm-10">reset password akan sama dengan nomor telepon</label>
            </div> 
            <div class="col-sm-4 pull-right">
              ...
              <button type="submit" class="btn btn-default" name="resetpassword">Reset Password</button>
            </div>
